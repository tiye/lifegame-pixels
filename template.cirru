...
var
  ...
  ({}~ html head title meta link script body div style createElement) stir

  logoUrl :http://logo.cirru.org/cirru-32x32.png
  cdnUrl $ cond (is process.env.local :true) : :http://cdn.tiye.me/lifegame-pixels/
